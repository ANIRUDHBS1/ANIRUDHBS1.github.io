...
An Apple Watch Series 3 with a 38 mm display (for 272 by 340 pixels) has a display area of 563 mm$$^2$$ as specified on [https://support.apple.com/en-us/111891](Apple's official specification). The fraction of area occupied by all the amplifiers as a fraction of the total display area is only about 10%. 
...
<div style="display: flex; gap: 10px; text-align: center;">
  <figure style="width: 100%; margin: 0;">
    <img src="/images/240A-6.png" style="width: 100%;">
...
<div style="display: flex; gap: 10px; text-align: center;">
  <figure style="width: 100%; margin: 0;">
    <img src="/images/240A-7.png" style="width: 100%;">
